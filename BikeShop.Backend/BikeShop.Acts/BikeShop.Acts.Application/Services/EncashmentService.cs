...
namespace BikeShop.Acts.Application.Services
{
    public class EncashmentService : IEncashmentService
    {
        ...
        public async Task<Encashment> Create(CreateEncashmentDTO dto)
        {
            ...
            var ent = new Encashment { ShopId = dto.ShopId, Card = dto.Cash, Cash = dto.Cash, Description = dto.Description, Status = "InShop", UserCreated = dto.UserId,  UserUpdated = dto.UserId };
